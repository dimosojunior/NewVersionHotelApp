...
import HotelFoodReportsComponent from '../RenderedComponents/HotelFoodReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserHotelFoodReportsComponent from '../GetUserOrdersReportsComponents/UserHotelFoodReportsComponent';


export default function HotelFoodReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Food Hotel Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserHotelFoodReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <HotelFoodReportsComponent username={username} id={id} />}
