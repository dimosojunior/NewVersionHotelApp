...
import HotelDrinksReportsComponent from '../RenderedComponents/HotelDrinksReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserHotelDrinksReportsComponent from '../GetUserOrdersReportsComponents/UserHotelDrinksReportsComponent';


export default function HotelDrinksReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Drinks Hotel Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserHotelDrinksReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <HotelDrinksReportsComponent username={username} id={id} />}
