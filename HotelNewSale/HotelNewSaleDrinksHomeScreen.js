...
export default function HotelNewSaleDrinksHomeScreen({navigation}) {
...
<MinorHeader  title="Drinks"  screenName="Hotel NewSale"/>
...
{/*-------------MWANZO WA ITEM 1---------*/}
      <TouchableOpacity 
       activeOpacity={1}
         ...
         onPress={() => navigation.navigate('Hotel Drinks Walking Customers')}>
      ...
      <MotiView
        ...
        <Text style={globalstyles.HoteCategoriesnameText}> Walking Customers</Text>
...
<View style={{
  ...
  marginRight:0,
    ...
    {/*-------------MWANZO WA ITEM 3---------*/}
      <TouchableOpacity 
       activeOpacity={1}
         onPress={() => navigation.navigate('Hotel Drinks Guest Customers')}>
      ...
      <MotiView
        ...
        <Text style={globalstyles.HoteCategoriesnameText}>Guest Customers</Text>
