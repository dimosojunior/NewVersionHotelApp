...
const HotelFoodWalkingCustomersHomeScreen =({navigation }) => {
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('All Hotel Walking Food', item)}
            >
...
export default HotelFoodWalkingCustomersHomeScreen;
