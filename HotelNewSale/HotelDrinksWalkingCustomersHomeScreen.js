...
const HotelDrinksWalkingCustomersHomeScreen =({navigation }) => {
...
const [CategoryName, setCategoryName] = useState('');
    const move = (CategoryName) =>{
      ...
      navigation.navigate('Hotel NewSale ' +CategoryName);
    }
...
<MinorHeader title="Drinks" pressMe={AddFood} screenName="Hotel NewSale Drinks" />
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('All Hotel Walking Drinks', item)}
            >
...
export default HotelDrinksWalkingCustomersHomeScreen;
