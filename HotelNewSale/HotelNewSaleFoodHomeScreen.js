...
export default function HotelNewSaleFoodHomeScreen({navigation}) {
...
<MinorHeader  title="Food"  screenName="Hotel NewSale"/>
...
{/*-------------MWANZO WA ITEM 1---------*/}
      <TouchableOpacity 
       activeOpacity={1}
         ...
         onPress={() => navigation.navigate('Hotel Food Walking Customers')}>
...
<View style={{
  ...
  marginRight:0,
    ...
    {/*-------------MWANZO WA ITEM 3---------*/}
      <TouchableOpacity 
       activeOpacity={1}
         onPress={() => navigation.navigate('Hotel Food Guest Customers')}>
