...
const HotelDrinksGuestCustomersHomeScreen =({navigation }) => {
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('All Hotel Guest Drinks', item)}
            >
...
export default HotelDrinksGuestCustomersHomeScreen;
