...
export default function HotelNewSaleRoomsHomeScreen({navigation}) {
...
<MinorHeader  title="Rooms"  screenName="Hotel NewSale"/>
...
<View style={{
  ...
  justifyContent:'center'
    ...
    {/*-------------MWANZO WA ITEM 3---------*/}
      <TouchableOpacity 
       activeOpacity={1}
         onPress={() => navigation.navigate('Hotel Rooms Guest Customers')}>
