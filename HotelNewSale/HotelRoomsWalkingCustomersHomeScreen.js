...
const HotelRoomsWalkingCustomersHomeScreen =({navigation }) => {
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          ...
          return (
            ...
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('All Hotel Walking Rooms', item)}
            >
...
export default HotelRoomsWalkingCustomersHomeScreen;
