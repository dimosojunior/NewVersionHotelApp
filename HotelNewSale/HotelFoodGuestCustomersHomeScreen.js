...
const HotelFoodGuestCustomersHomeScreen =({navigation }) => {
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('All Hotel Guest Food', item)}
            >
...
export default HotelFoodGuestCustomersHomeScreen;
