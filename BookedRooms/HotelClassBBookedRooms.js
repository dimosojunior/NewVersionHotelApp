...
const HotelClassBBookedRooms =({navigation }) => {
 ...
 //    ]);
  ...
  //const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelBookedRoomsClassB/');
...
const ClickToAddBookedRoom =() =>{
  ...
  navigation.navigate('Inventory Rooms Class B')
}
...
<MinorHeader title="Class B Booked Rooms" pressMe={AddBooked} screenName="Inventory Rooms Class B"/>
...
export default HotelClassBBookedRooms;
