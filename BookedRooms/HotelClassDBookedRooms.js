...
const HotelClassDBookedRooms =({navigation }) => {
 ...
 //    ]);
  ...
  //const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelBookedRoomsClassD/');
...
const ClickToAddBookedRoom =() =>{
  ...
  navigation.navigate('Inventory Rooms Class D')
}
...
<MinorHeader title="Class D Booked Rooms" pressMe={AddBooked} screenName="Inventory Rooms Class D"/>
...
export default HotelClassDBookedRooms;
