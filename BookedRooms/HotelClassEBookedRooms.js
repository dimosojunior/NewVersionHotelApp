...
const HotelClassEBookedRooms =({navigation }) => {
 ...
 //    ]);
  ...
  //const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelBookedRoomsClassE/');
...
const ClickToAddBookedRoom =() =>{
  ...
  navigation.navigate('Inventory Rooms Class E')
}
...
<MinorHeader title="Class E Booked Rooms" pressMe={AddBooked} screenName="Inventory Rooms Class E"/>
...
export default HotelClassEBookedRooms;
