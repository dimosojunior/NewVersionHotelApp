...
const HotelClassCBookedRooms =({navigation }) => {
 ...
 //    ]);
  ...
  //const [isPending, setIsPending] = useState(false);
   ...
   //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelBookedRoomsClassC/');
...
const ClickToAddBookedRoom =() =>{
  ...
  navigation.navigate('Inventory Rooms Class C')
}
...
<MinorHeader title="Class C Booked Rooms" pressMe={AddBooked} screenName="Inventory Rooms Class C"/>
...
export default HotelClassCBookedRooms;
