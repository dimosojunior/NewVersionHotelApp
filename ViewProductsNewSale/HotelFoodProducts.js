...
const HotelFoodProducts =({route, navigation}) => {
  ...
  try {
    const response = await axios.post(
     ...
     //setShouldReload(true); 
      //navigation.replace('Hotel Food Products'); 
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Hotel NewSale Food" />
          ...
          <View style={globalstyles.ModalView}>
            ...
            <View style={globalstyles.form}>
               ...
               <View style={globalstyles.ButtonConatiner}>
                    ...
                    <TouchableOpacity 
                    style={globalstyles.ButtonAdd}  
                    onPress={() => navigation.navigate('Hotel Food Reports')} >
                        <Text style={{
                          color:'white',
                        }}>CONFIRM</Text>
                    </TouchableOpacity>
...
export default HotelFoodProducts;
