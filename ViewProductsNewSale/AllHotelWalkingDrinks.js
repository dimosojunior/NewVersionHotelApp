...
const AllHotelWalkingDrinks =({route, navigation}) => {
...
//navigation.replace('All Hotel Walking Drinks',id);
navigation.replace('All Hotel Walking Drinks', { id });
  ...
  try {
    const response = await axios.post(
      EndPoint + '/Cart/HotelDrinksAddToCartWithoutRoom/',
      {
     ...
     //setShouldReload(true); 
      //navigation.replace('All Hotel Walking Drinks'); 
...
export default AllHotelWalkingDrinks;
