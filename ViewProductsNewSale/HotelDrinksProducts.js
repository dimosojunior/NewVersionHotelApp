...
const HotelDrinksProducts =({route, navigation}) => {
...
//navigation.replace('Hotel Food Products',id);
navigation.replace('Hotel Drinks Products', { id });
  ...
  try {
    const response = await axios.post(
     ...
     //setShouldReload(true); 
      //navigation.replace('Hotel Drinks Products'); 
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Hotel NewSale Drinks" />
          ...
          <View style={globalstyles.ModalView}>
            ...
            <View style={globalstyles.form}>
               ...
               <View style={globalstyles.ButtonConatiner}>
                    ...
                    <TouchableOpacity 
                    style={globalstyles.ButtonAdd}  
                    onPress={() => navigation.navigate('Hotel Drinks Reports')} >
                        <Text style={{
                          color:'white',
                        }}>CONFIRM</Text>
                    </TouchableOpacity>
...
export default HotelDrinksProducts;
