...
const RestaurantFoodProducts =({route, navigation}) => {
...
console.log("HEADER NAME",HeaderName);
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setQueryset, isLoa, error } = useFetch(EndPoint+'/PostData/PostRestaurantFoodProducts/');
...
//navigation.replace('Restaurant Food Products',id);
navigation.replace('Restaurant Food Products', { id });
  ...
  try {
    const response = await axios.post(
      EndPoint + '/Cart/RestaurantFoodAddToCartWithoutRoom/',
      {
     ...
     //setShouldReload(true); 
      //navigation.replace('Restaurant Food Products'); 
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Restaurant NewSale Food" />
          ...
          <View style={globalstyles.ModalView}>
            ...
            <View style={globalstyles.form}>
               ...
               <View style={globalstyles.ButtonConatiner}>
                    ...
                    <TouchableOpacity 
                    style={globalstyles.ButtonAdd}  
                    onPress={() => navigation.navigate('Food Restaurant Waiters')} >
                        <Text style={{
                          color:'white',
                        }}>CONFIRM</Text>
                    </TouchableOpacity>
