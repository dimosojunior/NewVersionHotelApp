...
const AllHotelGuestFood =({route, navigation}) => {
...
// State variable to store the RoomClasses data
 ...
 const handleSubmit = () => {
  if (
    ...
    fetch(EndPoint + '/PostData/PostHotelFoodProducts/', {
      method: 'POST',
      headers: {
...
//navigation.replace('All Hotel Guest Food',id);
navigation.replace('All Hotel Guest Food', { id });
  ...
  try {
    const response = await axios.post(
     ...
     //setShouldReload(true); 
      //navigation.replace('All Hotel Guest Food'); 
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Hotel Food Guest Customers" />
...
export default AllHotelGuestFood;
