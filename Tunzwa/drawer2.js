...
//   );
 ...
 const isAdmin = userData.is_admin;
  const isHotelUser = userData.is_hotel_user;
  const isRestaurantUser = userData.is_restaurant_user;
  const isRetailUser = userData.is_retail_user;
