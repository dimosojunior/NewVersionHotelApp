...
const RetailsInventoryPizza =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsPizzaProducts/');
...
<AddMinorHeader title="Pizza" pressMe={AddFood} screenName="Retails Inventory Food" />
...
export default RetailsInventoryPizza;
