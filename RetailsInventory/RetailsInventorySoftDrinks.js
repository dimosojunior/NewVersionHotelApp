...
const RetailsInventorySoftDrinks =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsSoftDrinksProducts/');
...
<AddMinorHeader title="Soft Drinks" pressMe={AddFood} screenName="Retails Inventory Drinks" />
...
export default RetailsInventorySoftDrinks;
