...
const RetailsInventoryBeer =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsBeersProducts/');
...
<AddMinorHeader title="Beers" pressMe={AddFood} screenName="Retails Inventory Drinks" />
...
export default RetailsInventoryBeer;
