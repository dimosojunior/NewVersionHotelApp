...
import RestaurantDrinksReportsComponent from '../RenderedComponents/RestaurantDrinksReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserRestaurantDrinksReportsComponent from '../GetUserOrdersReportsComponents/UserRestaurantDrinksReportsComponent';


export default function RestaurantDrinksReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Drinks Restaurant Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserRestaurantDrinksReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <RestaurantDrinksReportsComponent username={username} id={id} />}
