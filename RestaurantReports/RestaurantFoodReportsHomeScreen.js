...
import RestaurantFoodReportsComponent from '../RenderedComponents/RestaurantFoodReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserRestaurantFoodReportsComponent from '../GetUserOrdersReportsComponents/UserRestaurantFoodReportsComponent';


export default function RestaurantFoodReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Food Restaurant Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserRestaurantFoodReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <RestaurantFoodReportsComponent username={username} id={id} />}
