...
const DrinksRestaurantWaitersHomeScreen =({navigation }) => {
...
useFocusEffect(
 ...
 // const [bookedDrinks, setBookedDrinks] = useState([
 //  {
 //    RoomName:'Room 5',
 //    RoomClass:'class A',
 //    RoomFloor:'Floor 4',
...
const ClickToAddBookedRoom =() =>{
  ...
  navigation.navigate('Inventory Drinks Drinks')
}
...
*/}         
      ...
      <TouchableOpacity
      onPress={() => navigation.replace('Restaurant Drinks Reports', item)} 
      >
        <View 
...
{queryset && queryset.length > 0 ? (
 ...
 <View style={globalstyles.UnitcartCard}>
      ...
      {userData.username && 
       ...
       <TouchableOpacity
      onPress={() => navigation.replace('Restaurant Drinks Reports', userData.id)} 
      >
        <View 
        style={globalstyles.UnitCartActionButtonText}
        >
...
export default DrinksRestaurantWaitersHomeScreen;
