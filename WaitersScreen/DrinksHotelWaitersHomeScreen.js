...
const DrinksHotelWaitersHomeScreen =({navigation }) => {
...
*/}         
      ...
      <TouchableOpacity
      onPress={() => navigation.replace('Hotel Drinks Reports', item)} 
      >
        <View 
...
{queryset && queryset.length > 0 ? (
 ...
 <View style={globalstyles.UnitcartCard}>
      ...
      {userData.username && 
       ...
       <TouchableOpacity
      onPress={() => navigation.replace('Hotel Drinks Reports', userData.id)} 
      >
        <View 
        style={globalstyles.UnitCartActionButtonText}
        >
...
export default DrinksHotelWaitersHomeScreen;
