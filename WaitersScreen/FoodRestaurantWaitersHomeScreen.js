...
const FoodRestaurantWaitersHomeScreen =({navigation }) => {
...
*/}         
      ...
      <TouchableOpacity
      onPress={() => navigation.replace('Restaurant Food Reports', item)} 
      >
        <View 
...
{queryset && queryset.length > 0 ? (
 ...
 <View style={globalstyles.UnitcartCard}>
      ...
      {userData.username && 
       ...
       <TouchableOpacity
      onPress={() => navigation.replace('Restaurant Food Reports', userData.id)} 
      >
        <View 
        style={globalstyles.UnitCartActionButtonText}
        >
...
export default FoodRestaurantWaitersHomeScreen;
