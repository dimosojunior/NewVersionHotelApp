...
const RestaurantNewSaleFoodHomeScreen =({navigation }) => {
...
<MinorHeader title="Food" pressMe={AddFood} screenName="Restaurant NewSale" />
        ...
        renderItem={({item, index}) => {
          ...
          return (
           <>
            <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Restaurant Food Products', item)}
            >
...
export default RestaurantNewSaleFoodHomeScreen;
