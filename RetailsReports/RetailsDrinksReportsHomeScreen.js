...
import RetailsDrinksReportsComponent from '../RenderedComponents/RetailsDrinksReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserRetailsDrinksReportsComponent from '../GetUserOrdersReportsComponents/UserRetailsDrinksReportsComponent';


export default function RetailsDrinksReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Drinks Retails Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserRetailsDrinksReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <RetailsDrinksReportsComponent username={username} id={id} />}
