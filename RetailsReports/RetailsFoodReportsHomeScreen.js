...
import RetailsFoodReportsComponent from '../RenderedComponents/RetailsFoodReportsComponent';
import LotterViewScreen from '../Screens/LotterViewScreen';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
import UserRetailsFoodReportsComponent from '../GetUserOrdersReportsComponents/UserRetailsFoodReportsComponent';


export default function RetailsFoodReportsHomeScreen({route, navigation}) {
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Food Retails Waiters" />
      <KeyboardAvoidingView
...
{/*mwisho wa Report */}
      ...
      <UserRetailsFoodReportsComponent username={username} id={id} />}


      {userData && userData.is_supervisor === true &&
      <RetailsFoodReportsComponent username={username} id={id} />}
