...
const HotelInventoryPizza =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelPizzaProducts/');
...
<AddMinorHeader title="Pizza" pressMe={AddFood} screenName="Hotel Inventory Food" />
...
export default HotelInventoryPizza;
