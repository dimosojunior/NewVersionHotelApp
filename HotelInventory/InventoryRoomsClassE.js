...
const InventoryRoomsClassE =({navigation }) => {
...
<AddMinorHeader title="Class E Rooms" pressMe={AddRoom} screenName="Hotel Inventory Rooms" />
...
<TouchableOpacity 
         onPress={() => navigation.navigate('Hotel Class E Booked Rooms')}>
...
export default InventoryRoomsClassE;
