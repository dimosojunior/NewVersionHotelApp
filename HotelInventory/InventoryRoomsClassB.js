...
const InventoryRoomsClassB =({navigation }) => {
...
<AddMinorHeader title="Class B Rooms" pressMe={AddRoom} screenName="Hotel Inventory Rooms" />
...
<TouchableOpacity 
         onPress={() => navigation.navigate('Hotel Class B Booked Rooms')}>
...
export default InventoryRoomsClassB;
