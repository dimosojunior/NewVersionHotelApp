...
const HotelInventoryBeer =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelBeersProducts/');
...
<AddMinorHeader title="Beers" pressMe={AddFood} screenName="Hotel Inventory Drinks" />
...
export default HotelInventoryBeer;
