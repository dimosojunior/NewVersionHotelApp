...
const HotelInventoryOtherFood =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelOtherFoodProducts/');
 ...
 const handleSubmit = () => {
  if (
    ...
    fetch(EndPoint + '/PostData/PostHotelOtherFoodProducts/', {
      method: 'POST',
      headers: {
...
<AddMinorHeader title="Food" pressMe={AddFood} screenName="Hotel Inventory Food" />
...
export default HotelInventoryOtherFood;
