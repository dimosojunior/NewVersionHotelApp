...
const InventoryRoomsClassA =({navigation }) => {
...
//FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelRoomsClassA/');
...
<AddMinorHeader title="Class A Rooms" pressMe={AddRoom} screenName="Hotel Inventory Rooms" />
...
export default InventoryRoomsClassA;
