...
const InventoryRoomsClassC =({navigation }) => {
...
<AddMinorHeader title="Class C Rooms" pressMe={AddRoom} screenName="Hotel Inventory Rooms" />
...
<TouchableOpacity 
         onPress={() => navigation.navigate('Hotel Class C Booked Rooms')}>
...
export default InventoryRoomsClassC;
