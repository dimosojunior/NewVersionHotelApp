...
const HotelInventorySoftDrinks =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelSoftDrinksProducts/');
...
<AddMinorHeader title="Soft Drinks" pressMe={AddFood} screenName="Hotel Inventory Drinks" />
...
export default HotelInventorySoftDrinks;
