...
const RestaurantInventoryOtherFood =({navigation }) => {
...
<AddMinorHeader title="Food" pressMe={AddFood} screenName="Restaurant Inventory Food" />
...
export default RestaurantInventoryOtherFood;
