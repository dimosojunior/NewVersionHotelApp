...
const RestaurantInventoryBeer =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRestaurantBeersProducts/');
...
<AddMinorHeader title="Beers" pressMe={AddFood} screenName="Restaurant Inventory Drinks" />
...
export default RestaurantInventoryBeer;
