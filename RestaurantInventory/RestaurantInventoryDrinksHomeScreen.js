...
const RestaurantInventoryDrinksHomeScreen =({navigation }) => {
...
<MinorHeader title="Drinks" pressMe={AddFood} screenName="Restaurant Inventory" />
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          ...
          return (
           ...
           <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Restaurant Inventory Drinks Products', item)}
            >
...
export default RestaurantInventoryDrinksHomeScreen;
