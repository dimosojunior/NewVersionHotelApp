...
const RestaurantInventoryPizza =({navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRestaurantPizzaProducts/');
...
<AddMinorHeader title="Pizza" pressMe={AddFood} screenName="Restaurant Inventory Food" />
...
export default RestaurantInventoryPizza;
