...
const RetailsNewSaleFoodHomeScreen =({navigation }) => {
...
<MinorHeader title="Food" pressMe={AddFood} screenName="Retails NewSale" />
...
{inventory && inventory.length > 0 ? (
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          ...
          <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Retails Food Products', item)}
            >
...
export default RetailsNewSaleFoodHomeScreen;
