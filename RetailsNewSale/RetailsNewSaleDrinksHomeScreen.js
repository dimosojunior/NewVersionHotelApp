...
const RetailsNewSaleDrinksHomeScreen =({navigation }) => {
...
const [CategoryName, setCategoryName] = useState('');
    const move = (CategoryName) =>{
      ...
      navigation.navigate('Retails NewSale ' +CategoryName);
    }
...
<MinorHeader title="Drinks" pressMe={AddFood} screenName="Retails NewSale" />
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          ...
          return (
           ...
           <TouchableOpacity 
             activeOpacity={1}
             onPress={() => navigation.navigate('Retails Drinks Products', item)}
            >
...
export default RetailsNewSaleDrinksHomeScreen;
