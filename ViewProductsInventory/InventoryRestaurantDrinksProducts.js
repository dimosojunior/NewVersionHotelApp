...
const InventoryRestaurantDrinksProducts =({route ,navigation }) => {
...
const AddDrinks =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRestaurantOtherDrinksProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={AddDrinks} screenName="Restaurant Inventory Drinks" />
...
export default InventoryRestaurantDrinksProducts;
