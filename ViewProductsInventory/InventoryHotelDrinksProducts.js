...
const InventoryHotelDrinksProducts =({route ,navigation }) => {
...
const AddDrinks =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostHotelOtherDrinksProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={AddDrinks} screenName="Hotel Inventory Drinks" />
...
export default InventoryHotelDrinksProducts;
