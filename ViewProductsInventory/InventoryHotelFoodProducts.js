...
const InventoryHotelFoodProducts =({route ,navigation }) => {
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Hotel Inventory Food" />
...
export default InventoryHotelFoodProducts;
