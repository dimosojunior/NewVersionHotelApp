...
const InventoryRetailsFoodProducts =({route ,navigation }) => {
...
const AddFood =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsOtherFoodProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={AddFood} screenName="Retails Inventory Food" />
...
export default InventoryRetailsFoodProducts;
