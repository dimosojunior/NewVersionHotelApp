...
const InventoryRetailsDrinksProducts =({route ,navigation }) => {
...
const AddDrinks =() =>{
 ...
 //FOR APIS
//const { datas:myItems,setDatas:setMyItems, isPending, error } = useFetch(EndPoint+'/PostData/PostRetailsOtherDrinksProducts/');
...
<AddMinorHeader title={HeaderName} pressMe={AddDrinks} screenName="Retails Inventory Drinks" />
...
export default InventoryRetailsDrinksProducts;
